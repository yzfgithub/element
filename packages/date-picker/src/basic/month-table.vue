...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'kpl-ui/src/utils/date-util';
  import { hasClass } from 'kpl-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'kpl-ui/src/utils/util';
